    ...
    <div class="container text-center">
      <div class="row">
        <div class="col">
          ...
          <hr>
            <a href="/addClients" class="btn btn-primary" style="background-color:darkcyan;float:right;margin-bottom:20px;">Ajouter un client</a>
            <table class="table  table-bordered ">
              ...
              <!-- Bouton pour ouvrir le modal -->
                    <a href="updateclient.php>"class="btn"  style="background-color:darkcyan;">
